...
while True:
    ...
    while len(queue) != 0:
        ...
        # NOTE:
        #   All components connected to the parent of 'rx' will send a high signal with a given period.
        #   Find the period for all the input components of the parent of 'rx' and calculate the value
        #   where all sends a high signal at the same time.
        if receiver == "PARENT_OF_RX" and sig == HI:
            print(i, sender)
